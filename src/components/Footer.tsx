...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-gray-900 to-emerald-900 text-white font-montserrat">
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-12 h-12 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-xl flex items-center justify-center overflow-hidden shadow-lg">
              ...
              <div>
                ...
                <div className="text-sm text-emerald-200">Menschliche Pflege mit Herz</div>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-emerald-100">
              ...
              <li>
                <span className="block">24/7 Notfallbetreuung</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-emerald-100">
              <div className="flex items-center space-x-3 group">
                <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                  <Phone className="w-5 h-5 text-white" />
                </div>
                <div>
                  <div className="font-medium text-white">06103-8025731</div>
                  <div className="text-sm text-emerald-200">Telephone</div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 group">
                ...
                <div>
                  ...
                  <div className="text-sm text-emerald-200">Mobile</div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 group">
                ...
                <div>
                  ...
                  <div className="text-sm text-emerald-200">Freiherr-vom-Stein-Straße 42</div>
                  <div className="text-sm text-emerald-200">63303 Dreieich-Sprendlingen</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Bottom Section */}
        <div className="border-t border-emerald-700/50 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-emerald-200 text-sm">
© Copyright by Ambulanter Pflegedienst 3eich. Alle Rechte vorbehalten.            </div>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link to="/privacy" className="text-emerald-200 hover:text-white text-base transition-colors duration-300 font-medium">
                Datenschutz
              </Link>
              <Link to="/imprint" className="text-emerald-200 hover:text-white text-base transition-colors duration-300 font-medium">
                Impressum
              </Link>
            </div>
          </div>
